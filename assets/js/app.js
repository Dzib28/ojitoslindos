...
btnSi.addEventListener('click', ()=>{
    ...
    btnGift.textContent = 'Obten tus flores';
    btnGift.classList.add('botones_gift-button-style');
    btnGift.addEventListener('click', () => {
        
        window.location.href = './flower.html'; // Reemplaza con la URL del regalo
    });
    
    document.body.appendChild(btnGift);
